...
Their main claim to fame comes from being extensively featured in [Andrew Ng's introduction to Machine Learning class on Coursera](https://www.coursera.org/learn/machine-learning). For this reason, a lot of newcomers to the field absolutely love autoencoders and can't get enough of them. This is the reason why this tutorial exists!
